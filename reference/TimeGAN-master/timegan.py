...
def timegan (ori_data, parameters):
  ...
  def embedder (X, T):
    ...
    with tf.variable_scope("embedder", reuse = tf.AUTO_REUSE):
      ...
      H = tf.layers.dense(e_outputs, hidden_dim, activation ='sigmoid')     #
    return H
  ...
  def recovery (H, T):   
    ...
    with tf.variable_scope("recovery", reuse = tf.AUTO_REUSE):       
      ...
      X_tilde = tf.layers.dense(r_outputs, dim, activation ='sigmoid') #
    return X_tilde
  ...
  def generator (Z, T):  
    ...
    with tf.variable_scope("generator", reuse = tf.AUTO_REUSE):
      ...
      E = tf.layers.dense(e_outputs, hidden_dim, activation='sigmoid')     #
    return E
  ...
  def supervisor (H, T): 
    ...
    with tf.variable_scope("supervisor", reuse = tf.AUTO_REUSE):
      ...
      S = tf.layers.dense(e_outputs, hidden_dim, activation ='sigmoid')     #
    return S
